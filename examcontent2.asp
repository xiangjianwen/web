...
if rid="姓名" then
'      if text <> "" then
				  strSQL = "Select * from Lxexam82 where a2='姓名' or a2 like '%"&text& "%'ORDER BY a28 desc"
				   rst.open strSQL, my_conn,1
...
'	   response.write("<ul>请输入姓名</ul>")
	 ...
	 bj="1"
	  strSQL = "Select * from Lxexam82 WHERE a3='" & bj & "' or a2='姓名' ORDER BY a28 desc "
   aa(strSQL)
   elseif rid ="82" then
    bj="2"
	strSQL = "Select * from Lxexam82 WHERE a3='" & bj & "' or a2='姓名' ORDER BY a28 desc "
